...
echo_and_run cd "/home/insaf/ros_ws/src/modbus/modbus_plc_siemens"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/insaf/ros_ws/src/modbus/modbus_plc_siemens/setup.py" \
     \
    build --build-base "/home/insaf/ros_ws/build/modbus/modbus_plc_siemens" \
    install \
    --root="${DESTDIR-/}" \
